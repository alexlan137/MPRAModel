...
def eval_mpra():
    ...
    CBP = load('models/GM12878/chrombpnet_wo_bias.h5')
    print("CBP loaded from file")
    print(CBP.summary())

    XR_test = np.load('data/MPRA_partitioned/KampmanV1/XR.npy')
    XA_test = np.load('data/MPRA_partitioned/KampmanV1/XA.npy')
    ...
    results.to_csv('MPRA_data_analysis/Kampman/KampmanV1CBPmetrics/preds_GM12878.csv')
    np.save('MPRA_data_analysis/Kampman/KampmanV1CBPmetrics/preds_GM12878', np.array(CBPpreds))
    print(results.info())
